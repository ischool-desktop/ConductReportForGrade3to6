...
namespace ConductReportForGrade3to6
{
    public class Program
    {
        ...
        public static void main()
        {
            ...
            item1["報表"]["成績相關報表"]["ConductGradeReport(for Gr.3-6; 2014年以前適用)"].Enable = false;
            item1["報表"]["成績相關報表"]["ConductGradeReport(for Gr.3-6; 2014年以前適用)"].Click += delegate
            {
            ...
            K12.Presentation.NLDPanels.Student.SelectedSourceChanged += delegate
            {
                ...
                {
                    item1["報表"]["成績相關報表"]["ConductGradeReport(for Gr.3-6; 2014年以前適用)"].Enable = true;
                }
                else
                {
                    item1["報表"]["成績相關報表"]["ConductGradeReport(for Gr.3-6; 2014年以前適用)"].Enable = false;
            ...
            permission.Add(new RibbonFeature(Permissions.ConductGradeReport, "ConductGradeReport(for Gr.3-6; 2014年以前適用)"));
        }
    }
}
