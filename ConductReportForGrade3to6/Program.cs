...
namespace ConductReportForGrade3to6
{
    public class Program
    {
        ...
        public static void main()
        {
            ...
            item1["報表"]["成績相關報表"]["ConductGradeReport(for Grade 3-6)"].Enable = false;
            item1["報表"]["成績相關報表"]["ConductGradeReport(for Grade 3-6)"].Click += delegate
            {
            ...
            K12.Presentation.NLDPanels.Student.SelectedSourceChanged += delegate
            {
                ...
                {
                    item1["報表"]["成績相關報表"]["ConductGradeReport(for Grade 3-6)"].Enable = true;
                }
                else
                {
                    item1["報表"]["成績相關報表"]["ConductGradeReport(for Grade 3-6)"].Enable = false;
            ...
            permission.Add(new RibbonFeature(Permissions.ConductGradeReport, "ConductGradeReport(for Grade 3-6)"));
        }
    }
}
